    ...
    <div class="page">
        ...
        <div class="address2">
            <div class="clearfix" style="margin-bottom: 20px;">
                <span style="float:left">
                    <br />
                    <h2 style="color:{{ $data[1]['primary_colour'] ? $data[1]['primary_colour'] : '#153D58'}}">Work Order</h2>
                ...
                <div style="float:right; margin-right: 40px;">
                    <br />
                    <br />
                    <span style="color:{{ $data[1]['primary_colour'] ? $data[1]['primary_colour'] : '#153D58' }}; font-weight: bold; font-size: 1.5rem;"
                        >Job number - {{ $data[0]["job_number"] }}</span><br>
        ...
        <div class="clearfix" style="margin-bottom: 20px;">
            <div style="width: 40%;">
                <span style="float:left">
                    <br />
                    <h2  style="color:{{ $data[1]['primary_colour'] ? $data[1]['primary_colour'] : "#153D58"}}">Details</h2>
                    <p>Property</p>
                    ...
                    <p>Work order issued on behalf of the owner - {{ $data[0]["owner_name"] }}</p>
                </span>
            </div>
        ...
        <hr>
        <div>
            <h2 style="color:{{ $data[1]['primary_colour'] ? $data[1]['primary_colour'] : '#153D58'}}">Description</h2>
